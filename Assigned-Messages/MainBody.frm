...
background-position:8px; font-size:14px; outline:none; float:left}
  ...
  .t_content{padding-top:15px;    border-bottom: 1px solid #ccc;
float: left; width: 100%;}
   ...
   .ans_in {
    ...
    .showtopfaq{padding: 8px 0px 8px 0px; position: absolute; top:0;width: 100%;z-index:99999; display:none;}
	 .list_container {position:relative;  
      border-radius: 8px 8px 0 0; border:1px solid #dfdede;margin-bottom:20px;
     }
	 .tab_cont_main {
    float: left;
    width: 99%;
  ...
  .tab_section {
    ...
    *::before, *::after {
    ...
    .sort-icon{width:11px; height:14px;
...
.box_wrap-hide-setup.box-hide-start { opacity:0; height: 100px; }  .tab_section {
    float: left;
    width: 100%;
  }
  ...
  ul.tabs li:first-child a {
   ...
   .askqu .asksubmitbtn{margin-top: 20px;margin-bottom:10px;padding:8px;padding-left:15px; padding-right:15px; color:#fff;border:none; underline:none;background:#6c7ae0;  text-transform: uppercase;}
...
.pagination ul li a{text-decoration:none;}
.history-common-search-results{width:100%; float:lefft}
...
.history-common-search-results .history-content-row{width:100%;float:left; background:#fff; padding-top:10px; padding-bottom:10px; border-top:1px solid #e6e4e4;cursor:pointer}
...
.subscriptions .table-row{width:100%;float:left;}
...
.panel-group div{cursor:pointer}
...
.sharelink .slink{cursor:pointer;}
