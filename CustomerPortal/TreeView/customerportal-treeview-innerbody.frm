		...
		<div class="interaction-history" ng-controller="ControllerHistory">
		  <div class="history-common-search-results">
			<div class="history-heading">
			  <div class="column-subject"><span class="nglink" ng-click="SortClick('subject')">Subject</span><div class="sort-direction-indicator" ng-class="SortDirectionClass('subject')">
			  </div>
			</div>
